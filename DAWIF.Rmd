...
## Conclusions 
Overall there appears to be no association between the category of major and median income levels. This is a simplified assessment (adjusted R squared=0.01995). It is possible to analyse 